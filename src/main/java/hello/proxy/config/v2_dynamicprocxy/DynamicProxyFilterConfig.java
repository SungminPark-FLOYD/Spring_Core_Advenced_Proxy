package hello.proxy.config.v2_dynamicprocxy;

import hello.proxy.app.v1.*;
import hello.proxy.config.v2_dynamicprocxy.handler.LogTraceFilterHandler;
...
public class DynamicProxyFilterConfig {
    ...
    @Bean
    public OrderControllerV1 orderControllorV1(LogTrace logTrace) {
